...
const AvatarIcon = ({ icon, handleClick, iconData, selectedIcon } : IAvatarIcon ) => {
  return (
    <div 
      ...
      className={`${ selectedIcon === iconData.id && "ring-colorGreen" } w-10 h-10 p-1 rounded-full ring-2 ring-gray-500 flex items-center justify-center text-white text-2xl cursor-pointer
