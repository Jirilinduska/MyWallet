...
const Button = ({ value, loading, color, handleClick, buttonType }: ButtonProps) => {
    ...
    return (
      <button 
        ...
        className={`${handleColor()} border-none rounded-full text-sm px-5 flex items-center justify-center text-center mr-2 w-full mb-2 transition duration-300 ease-in-out focus:outline-none focus:ring-4 cursor-pointer`}
