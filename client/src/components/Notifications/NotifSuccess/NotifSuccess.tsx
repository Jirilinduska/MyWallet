...
import { INotif } from "../../../utils/interfaces/interfaces"

const NotifSuccess: React.FC<INotif> = ({ message, onClose }) => {
  ...
  return (
    <div       
        className={`${isVisible ? "flex" : "hidden"} fixed bottom-4 right-4 bg-black text-white p-4 rounded-lg shadow-lg flex items-center gap-4`}
        onTransitionEnd={() => {
